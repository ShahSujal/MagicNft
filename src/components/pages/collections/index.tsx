    ...
    <main className=" bg-[#c9d2e7] dark:bg-stone-900 h-screen w-full relative ">
      ...
      <div className=" w-full min-h-screen flex flex-row flex-wrap ">
        {[1, 2, 3, 4, 5].map((item) => (
          <Card
            key={item}
            className=" w-[300px] h-[350px] bg-[#ffffff31] mx-auto  "
          >
            <CardHeader className="relative">
              <Image
                ...
                src="https://images.unsplash.com/photo-1646038572815-43fe759e459b?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt="NFT"
              />
