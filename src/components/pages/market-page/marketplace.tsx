...
const MarketPlace = () => {
  ...
  {
    name: "Trending",
    description: "This NFT is currently trending due to its unique design and high demand. It represents the cutting-edge of digital art and is a must-have for any serious collector.",
    price: 100,
    image:
  ...
  {
    name: "Popular",
    description: "This NFT has gained immense popularity due to its vibrant colors and intricate details. It is a favorite among collectors and continues to attract attention from new buyers.",
    price: 200,
    image:
      "https://images.unsplash.com/photo-1604076850742-4c7221f3101b?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    symbol: "ETH",
